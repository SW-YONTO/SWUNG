...
- The current datetime provided above is in IST (India Standard Time).
- ALWAYS schedule events in the FUTURE, never in the past.
...
- Always use ISO 8601 format for datetime (YYYY-MM-DDTHH:mm:ss).
- Double-check that the datetime you generate is AFTER the current time.
